...
try:
    ...
    # 兼容直接执行文件: python backend/app/main.py
    import os
    import sys
    ...
    from app.routers import game_routes, history_routes, rag_routes
...
async def lifespan(app: FastAPI):
    ...
    try:
        try:
            ...
            from app.services.document_loader import APIDocumentLoader
    ...
    try:
        ...
        async def handle_game_task(payload):
            try:
                ...
                from app.services.history_service import history_service as hs  # 避免循环引用
